...
// UDP Client
//
// Between TCP Client and UDP Client, only socket initialization will change
//
...
//
// Using implemented ClientLogic and given UdpSocket
// Implement client loop logic (send, receive, errors...)
//
fn main() {
    let logic: Box<dyn ClientLogic> = Box::new(TestClientLogic::new());
    let mut socket: Box<dyn Client> = Box::new(UdpClient::new("0.0.0.0:0", "0.0.0.0:29999"));
